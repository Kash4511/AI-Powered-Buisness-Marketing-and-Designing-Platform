    ...
    try:
        ...
        try:
            ...
            docraptor_vars = {
                ...
                # Page 2 (Audience)
                'commercialLabel': template_vars.get('audience_analysis', {}).get('commercial_label', ''),
                'commercialAnalysis': template_vars.get('audience_analysis', {}).get('commercial_text', ''),
                'governmentLabel': template_vars.get('audience_analysis', {}).get('government_label', ''),
                'governmentAnalysis': template_vars.get('audience_analysis', {}).get('government_text', ''),
                'architectLabel': template_vars.get('audience_analysis', {}).get('architect_label', ''),
                'architectAnalysis': template_vars.get('audience_analysis', {}).get('architect_text', ''),
                'contractorLabel': template_vars.get('audience_analysis', {}).get('contractor_label', ''),
                'contractorAnalysis': template_vars.get('audience_analysis', {}).get('contractor_text', ''),
                
                # Page 4 (Chapter 1)
                'chapter1Title': template_vars.get('ch1', {}).get('title', ''),
                'chapter1Eyebrow': template_vars.get('ch1', {}).get('eyebrow', ''),
                'chapter1Section': template_vars.get('ch1', {}).get('section_id', 'CH 01'),
                'chapter1Intro': template_vars.get('ch1', {}).get('intro', ''),
                'chapter1Body1': template_vars.get('ch1', {}).get('body', ''),
                'callout1Title': template_vars.get('ch1', {}).get('impact_label', ''),
                'callout1Body': template_vars.get('ch1', {}).get('impact_value', ''),
                
                # Page 5 (Chapter 2)
                'chapter2Title': template_vars.get('ch2', {}).get('title', ''),
                'chapter2Eyebrow': template_vars.get('ch2', {}).get('eyebrow', ''),
                'chapter2Section': template_vars.get('ch2', {}).get('section_id', 'CH 02'),
                'chapter2Intro': template_vars.get('ch2', {}).get('intro', ''),
                'chapter2Body1': template_vars.get('ch2', {}).get('body', ''),
                'tradeoffsTitle': "CORE INTERVENTIONS",
                'tradeoff1Term': template_vars.get('solutions')[0].get('title') if template_vars.get('solutions') else "",
                'tradeoff1Desc': ", ".join(template_vars.get('solutions')[0].get('implementation_steps', [])) if template_vars.get('solutions') else "",
                'tradeoff2Term': template_vars.get('solutions')[1].get('title') if len(template_vars.get('solutions', [])) > 1 else "",
                'tradeoff2Desc': ", ".join(template_vars.get('solutions')[1].get('implementation_steps', [])) if len(template_vars.get('solutions', [])) > 1 else "",
                'tradeoff3Term': template_vars.get('solutions')[2].get('title') if len(template_vars.get('solutions', [])) > 2 else "",
                'tradeoff3Desc': ", ".join(template_vars.get('solutions')[2].get('implementation_steps', [])) if len(template_vars.get('solutions', [])) > 2 else "",
                'tradeoff4Term': "ROI Analysis",
                'tradeoff4Desc': template_vars.get('roi', {}).get('cost_savings', ""),
                'tradeoff5Term': "Competitive Edge",
                'tradeoff5Desc': template_vars.get('roi', {}).get('competitive_advantage', ""),
                'callout3Title': "Implementation Focus",
                'callout3Body': template_vars.get('roi_detailed', ''),

                # Page 6 (Implementation)
                'chapter3Title': template_vars.get('ch3', {}).get('title', ''),
                'chapter3Eyebrow': template_vars.get('ch3', {}).get('eyebrow', ''),
                'chapter3Section': template_vars.get('ch3', {}).get('section_id', 'CH 03'),
                'chapter3Intro': template_vars.get('ch3', {}).get('intro', ''),
                'phase1Title': template_vars.get('ch3', {}).get('phase_1', {}).get('title', ''),
                'phase1Desc': template_vars.get('ch3', {}).get('phase_1', {}).get('desc', ''),
                'phase2Title': template_vars.get('ch3', {}).get('phase_2', {}).get('title', ''),
                'phase2Desc': template_vars.get('ch3', {}).get('phase_2', {}).get('desc', ''),
                'callout4Title': "Strategic Outlook",
                'callout4Body': template_vars.get('conclusion', ''),

                # Mapping defaults for other required fields in Template.html
                'pageNumber4': '04', 'pageNumber5': '05', 'pageNumber6': '06',
                'pageNumber7': '07', 'pageNumber8': '08',
                'dropCap1': template_vars.get('drop_caps')[0] if len(template_vars.get('drop_caps', [])) > 0 else "S",
                'dropCap2': template_vars.get('drop_caps')[1] if len(template_vars.get('drop_caps', [])) > 1 else "F",
                'dropCap4': template_vars.get('drop_caps')[2] if len(template_vars.get('drop_caps', [])) > 2 else "C",
                'dropCap5': template_vars.get('drop_caps')[3] if len(template_vars.get('drop_caps', [])) > 3 else "M",
                
                'imagePlaceholderLabel1': template_vars.get('image_labels')[0] if len(template_vars.get('image_labels', [])) > 0 else "ANALYSIS",
                'imagePlaceholderLabel2': template_vars.get('image_labels')[1] if len(template_vars.get('image_labels', [])) > 1 else "SOLUTION",
                'imagePlaceholderLabel3': template_vars.get('image_labels')[2] if len(template_vars.get('image_labels', [])) > 2 else "ROADMAP",
                
                # Chapter 4 (Benchmarks)
                'chapter4Title': template_vars.get('ch4', {}).get('title', ''),
                'chapter4Eyebrow': template_vars.get('ch4', {}).get('eyebrow', ''),
                'chapter4Section': template_vars.get('ch4', {}).get('section_id', 'CH 04'),
                'chapter4Intro': template_vars.get('ch4', {}).get('intro', ''),
                'caseStudy1Title': template_vars.get('ch4', {}).get('case_study_1', {}).get('title', ''),
                'caseStudy1Desc': template_vars.get('ch4', {}).get('case_study_1', {}).get('desc', ''),
                'caseStudy1Result': template_vars.get('ch4', {}).get('case_study_1', {}).get('result', ''),
                'caseStudy2Title': template_vars.get('ch4', {}).get('case_study_2', {}).get('title', ''),
                'caseStudy2Desc': template_vars.get('ch4', {}).get('case_study_2', {}).get('desc', ''),
                'caseStudy2Result': template_vars.get('ch4', {}).get('case_study_2', {}).get('result', ''),
                'callout5Title': "Proven Results",
                'callout5Body': template_vars.get('ch4', {}).get('body', ''),
                
                # Chapter 5 (Methods)
                'chapter5Title': template_vars.get('ch5', {}).get('title', ''),
                'chapter5Eyebrow': template_vars.get('ch5', {}).get('eyebrow', ''),
                'chapter5Section': template_vars.get('ch5', {}).get('section_id', 'CH 05'),
                'chapter5Intro': template_vars.get('ch5', {}).get('intro', ''),
                'chapter5Body1': template_vars.get('ch5', {}).get('body', ''),
                'engagementMethodsTitle': "SERVICE LEVELS",
                'method1Phase': template_vars.get('ch5', {}).get('methods', [{}])[0].get('phase', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 0 else '',
                'method1Desc': template_vars.get('ch5', {}).get('methods', [{}])[0].get('desc', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 0 else '',
                'method2Phase': template_vars.get('ch5', {}).get('methods', [{},{}] )[1].get('phase', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 1 else '',
                'method2Desc': template_vars.get('ch5', {}).get('methods', [{},{}] )[1].get('desc', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 1 else '',
                'method3Phase': template_vars.get('ch5', {}).get('methods', [{},{},{}] )[2].get('phase', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 2 else '',
                'method3Desc': template_vars.get('ch5', {}).get('methods', [{},{},{}] )[2].get('desc', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 2 else '',
                'method4Phase': template_vars.get('ch5', {}).get('methods', [{},{},{},{}] )[3].get('phase', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 3 else '',
                'method4Desc': template_vars.get('ch5', {}).get('methods', [{},{},{},{}] )[3].get('desc', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 3 else '',
                'method5Phase': template_vars.get('ch5', {}).get('methods', [{},{},{},{},{}] )[4].get('phase', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 4 else '',
                'method5Desc': template_vars.get('ch5', {}).get('methods', [{},{},{},{},{}] )[4].get('desc', '') if len(template_vars.get('ch5', {}).get('methods', [])) > 4 else '',
