...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id', 'email', 'name', 'phone_number', 'is_developer', 'is_active', 'tokens_used', 'tokens_allocated', 'date_joined')
        read_only_fields = ('id', 'date_joined', 'is_developer', 'is_active', 'tokens_used', 'tokens_allocated')
